  ...
  return (
    <>
        ...
        <div ref={sliderRef} className="keen-slider">
          <div className="keen-slider__slide">
            <div className="w-28 h-28 bg-white border-2 border-solid border-black rounded-full overflow-hidden">
              <img
                src="images/Brands/bozorgmehr.png"
                alt="Bozorgmehr"
          ...
          <div className="keen-slider__slide">
            <div className="w-28 h-28 bg-white border-2 border-solid border-black rounded-full overflow-hidden">
              <img
                src="images/Brands/gheitaran.png"
                alt="Gheitaran"
                className="object-cover p-6 w-full h-full overflow-visible"
              />
            </div>
          ...
          <div className="keen-slider__slide">
            <div className="w-28 h-28 bg-white border-2 border-solid border-black rounded-full overflow-hidden">
              <img
                src="images/Brands/mohtasham.png"
                alt="Mohtasham"
                className="object-cover p-6 w-full h-full overflow-visible"
              />
            </div>
          ...
          <div className="keen-slider__slide">
            <div className="w-28 h-28 bg-white border-2 border-solid border-black rounded-full overflow-hidden">
              <img
                src="images/Brands/shahrokh.png"
                alt="Shahrokh"
                className="object-cover p-6 w-full h-full overflow-visible"
              />
            </div>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between w-full gap-5 my-8 px-2 lg:px-16">
        <img
          src="images/advertising1.jpg "
          alt="Advertising"
          className="flex-1 lg:w-1/3 rounded-xl object-cover"
        />
        <img
          src="images/advertising2.jpg"
          alt="Advertising"
          className="flex-1 lg:w-1/3 rounded-xl object-cover"
        />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 font-[Shabnam-Medium] px-2 lg:px-16 mb-10 xl:divide-x divide-solid divide-black xl:divide-x-reverse">
        <div className="px-5 flex flex-col items-center gap-4">
          ...
          >
            <img src="images/Icons/carpet.png" alt="Title Icon" className="w-7 inline-block ml-2" />
            <h4 className="inline-block">گلچین فرش های ماشینی</h4>
          </Link>
          <div className="grid grid-rows-2 grid-cols-2 gap-2">
            <img src="images/Carpets/01.jpg" alt="" className="w-40 h-68 object-cover" />
            <img src="images/Carpets/02.jpg" alt="" className="w-40 h-68 object-cover" />
            <img src="images/Carpets/03.jpg" alt="" className="w-40 h-68 object-cover" />
            <img src="images/Carpets/04.jpg" alt="" className="w-40 h-68 object-cover" />
          </div>
        </div>
        <div className="px-5 flex flex-col items-center gap-4">
          <Link
            ...
            className="inline-block transition-colors duration-300 hover:text-[var(--colorFive)] cursor-pointer after:mt-1 after:w-full after:h-1 after:block after:bg-red-600"
          >
            <img src="images/Icons/prayer.png" alt="Title Icon" className="w-7 inline-block ml-2" />
            <h4 className="inline-block">گلچین فرش های دستبافت</h4>
          </Link>
          <div className="grid grid-rows-2 grid-cols-2 gap-2">
            <img src="images/Carpets/05.jpg" alt="" className="w-40 h-68 object-cover" />
            <img src="images/Carpets/06.jpg" alt="" className="w-40 h-68 object-cover" />
            <img src="images/Carpets/07.jpg" alt="" className="w-40 h-68 object-cover" />
            <img src="images/Carpets/08.jpg" alt="" className="w-40 h-68 object-cover" />
          </div>
        </div>
        <div className="px-5 flex flex-col items-center gap-4">
          <Link
            ...
            className="inline-block transition-colors duration-300 hover:text-[var(--colorFive)] cursor-pointer after:mt-1 after:w-full after:h-1 after:block after:bg-red-600"
          >
            <img src="images/Icons/yoga-mat.png" alt="Title Icon" className="w-7 inline-block ml-2" />
            <h4 className="inline-block">گلچین انواع موکت</h4>
          </Link>
          <div className="grid grid-rows-2 grid-cols-2 gap-2">
            <img src="images/Carpets/09.jpg" alt="" className="w-40 h-68 object-cover" />
            <img src="images/Carpets/10.jpg" alt="" className="w-40 h-68 object-cover" />
            <img src="images/Carpets/11.jpg" alt="" className="w-40 h-68 object-cover" />
            <img src="images/Carpets/12.jpg" alt="" className="w-40 h-68 object-cover" />
          </div>
        </div>
        <div className="px-5 flex flex-col items-center gap-4">
          <Link
            ...
            className="inline-block transition-colors duration-300 hover:text-[var(--colorFive)] cursor-pointer after:mt-1 after:w-full after:h-1 after:block after:bg-red-600"
          >
            <img src="images/Icons/tag.png" alt="Title Icon" className="w-7 inline-block ml-2" />
