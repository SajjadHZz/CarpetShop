...
export default function CustomersComments() {
  ...
  return (
    <div className="w-full lg:w-1/3 mt-4 lg:m-0 border-2 border-solid border-black relative font-[Shabnam-Light] py-12 bg-white">
      ...
      <img src="images/Quotation.png" alt="Quotation" className="absolute w-12 top-0 right-0" />
      <img src="images/Quotation.png" alt="Quotation" className="absolute w-12 bottom-0 left-0 rotate-180" />
    </div>
  );
}
